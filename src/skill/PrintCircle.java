...
public class PrintCircle {
	...
	public static void main(String[] args) {
		...
		List<Integer> list = new ArrayList<>(); // uses list to print
	...
	public static void circle(int a[][], List<Integer> list, int start, int row, int col) {
		...
		// moves from top to bottom, at least 2 rows
		if (endY - start >= 1) {
		...
		// moves from right to left, at least 2 rows & 2 cols
		...
		// moves from bottom to top, at least 3 rows & 2 cols
